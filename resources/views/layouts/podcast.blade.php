...
<body class="h-screen">
    ...
    ?>
    <div id="app">
        <div class="wrapper min-h-screen w-full dark:bg-gray-900">
            @include('layouts.navbars.navbars')
            <div class="{{ $pageDirection }} flex justify-between w-screen  lg:flex-row   max-w-7xl ">
                <div class="flex-auto w-full lg:w-2/3 ">
                    @yield('content')
                </div>
                <div class="flex-auto w-full h-full lg:w-1/3 mt-4">
