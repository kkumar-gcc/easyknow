                ...
                @guest
                    @if (Route::has('login'))
                        <div class="hidden lg:flex items-center ml-6 ">
                            <a class="relative inline-flex items-center justify-center p-0.5  overflow-hidden text-sm font-medium no-underline mx-1.5 cursor-pointer whitespace-nowrap text-gray-900 rounded-lg group bg-gradient-to-br from-rose-500 to-pink-500  group-hover:from-rose-600 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-rose-800"
                                href="{{ route('login') }}">
                                <span
                    ...
                    @if (Route::has('register'))
                        <div class="hidden lg:flex  items-center ml-6 ">
                            <a type="button"
                                class="inline-block font-medium rounded-lg text-sm px-5 py-2.5 text-center no-underline mx-1.5 cursor-pointer whitespace-nowrap text-white bg-gradient-to-br from-rose-500 to-pink-500  hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-rose-800"
                ...
                @else
                    ...
                    <div class="hidden lg:flex  items-center ml-6 ">
                        ...
                        <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown"
                            ...
                            src="{{ asset(Auth::user()->profile_image) }}" onerror="this.onerror=null;this.src=`https://avatars.dicebear.com/api/bottts/:{{ Auth::user()->username }}.svg`" alt="User dropdown">

                        <div id="userDropdown"
                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(20px, 70px);"
                            data-popper-reference-hidden="true" data-popper-escaped="" data-popper-placement="bottom-start">
                            ...
                            <div class="flex justify-between py-3 font-medium translate-x-1">
                                <div class="flex items-center space-x-4">
                                    <img class="w-12 h-12 rounded-full"
                                        src="{{ asset(Auth::user()->profile_image ) }}" onerror="this.onerror=null;this.src=`https://avatars.dicebear.com/api/bottts/:{{ Auth::user()->username }}.svg`" alt="">
