@if (count($tags) > 0)
    <div class="row">
        @foreach ($tags as $tag)
            ...
            <div
                class="relative mb-4 w-full p-2.5 text-base text-left  border border-transparent rounded-3xl font-normal text-gray-700 dark:text-gray-400 hover:bg-gray-100 shadow dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
