            ...
            <section class="mt-4">
                ...
                <div class="border border-gray-300 p-8 rounded-xl mt-2">
                    <div id="carouselExample" class="carousel slide" data-bs-ride="true">
                        <!-- Carousel wrapper -->
                        <div class="carousel-inner  overflow-hidden relative rounded-lg h-56  sm:h-64 xl:h-80 2xl:h-96">
                            <!-- Item 1 -->
                            <div class="carousel-item active duration-700 ease-in-out absolute inset-0  h-full">
