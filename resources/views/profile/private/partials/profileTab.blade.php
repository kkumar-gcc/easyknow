    ...
    <div
        ...
        <div
            ...
            <form method="POST" id="profile_update" enctype="multipart/form-data">
                ...
                <input type="submit" class="sticky bottom-1 w-full mt-3 inline-flex justify-center items-center font-medium rounded-lg text-sm px-5 py-2.5 text-center no-underline cursor-pointer whitespace-nowrap text-white bg-gradient-to-br from-rose-600 to-pink-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-rose-300 dark:focus:ring-rose-800" value="save profile info" />
            </form>
